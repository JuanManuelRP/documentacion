...
#### Botón Filtro de Pacientes Incompletos

En el apartado de **Pacientes**, junto al buscador, se encuentra el **Filtro de Pacientes Incompletos**, identificado con un indicador numérico.\
Este filtro permite visualizar rápidamente aquellos pacientes que cuentan con información incompleta en su ficha, facilitando su identificación dentro del listado general.
