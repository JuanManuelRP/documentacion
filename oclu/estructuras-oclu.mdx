...
-   **Tu nombre** (derecha): Muestra tu nombre, y abre un menu con otros apartados (Mi suscripcion, configuracion, notas personales, cerrar sesion)
-   **Lupa del buscador** (derecha): Buscar atajos o pacientes
-   **Campana de notificaciones** (derecha): Alertas importantes
-   **Icono de mail **(derecha): Mensajeria interna de la clinica
